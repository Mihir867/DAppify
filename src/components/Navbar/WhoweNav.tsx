...
const SolutionNav = (props: Props) => {
  ...
  return (
    <li onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
        <button onClick={handleOnclick}  type='button' className={` text-lg flex max-lg:font-semibold hover:text-gray-300 items-center p-1 max-lg:justify-between max-lg:w-full ${show ? "lg:text-black": ""}`}>
            Who we serve
