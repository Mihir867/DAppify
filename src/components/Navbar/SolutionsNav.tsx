...
const OpenSourceNav = (props: Props) => {
  ...
  return (
        <li id='myLi'  onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} >
            <button onClick={handleOnclick} type='button' className={` text-lg flex items-center p-1 hover:text-gray-300 transition ease-in duration-150 max-lg:justify-between max-lg:font-semibold max-lg:w-full ${show ? "lg:text-black": ""}`}>
                Solutions
            ...
            <div className={`relative lg:absolute -ml-5 bg-white rounded-md lg:py-4 p-6 w-[320px] transition ease-in duration-150 ${show ? "opacity-100 visible" : "opacity-0 hidden"}`}>
                <div className='lg:border-b-[1px] mb-4 pb-6 pt-4 w-full'>
                    <span className='text-neutral-800 font-semibold text-base hover:text-blue-600'> Donation Forms <p className='text-sm font-normal text-neutral-500'>Raise more from anywhere on our site</p></span>
                </div>
                <div className='lg:border-b-[1px] mb-4 pb-6 pt-0 w-full'>
                    <span className='text-neutral-800 font-semibold text-base hover:text-blue-600'>Recurring giving <p className='text-sm font-normal text-neutral-500'>Power sustainable revenue growth and build a community </p></span>
                </div>
